...
| `WHATSAPP_DELETE_MAX_AGE_HOURS` | `0` (off) | Optional local age window for `DELETE /api/messages` revokes; stale messages are rejected with 403 before any protocol message is sent |
